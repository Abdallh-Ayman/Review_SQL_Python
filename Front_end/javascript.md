...
if you use this inside funtion that is **inside another function** this will not refer to the object. so the solution of this to make this function **arrow func** 
- **arrow func** : it don't make it's this it only inherit it from their parent 
```javascript
let person = {
    name: 'hambozo',
    age: 28,
    ...
    calcSalary: function () {
                function calcTax() {
                    return this.salary * 0.1; // this will refer to the window not to the person object as it is funtion inside another function 
                }
        return this.salary - calcTax(); 
    }
}

//you should make it arrow function 
...
let person = {
    ...
    calcSalary: function () {
                let calcTax = () => {
                    return this.salary * 0.1; // this will refer to the person object 
                }
        return this.salary - calcTax(); 
    }
}
...
- if we use it outsite the function it will contains the window object 
```javascript
console.log( this ) // it will print Window object with its funcitons and property 
this.alert('salad')
```

- if we use it inside **event** it will contain the element that the event made on it 
```html
<div onclick = "test(this)"> </div> // this  refer to the div element 
```

- **this** it is like self in python if you use it **inside object** it will contiaon this object  
```javascript
const cat = {
  name: "Pipey",
  age: 8,
...
- note: that if you use this inside funtion that is **inside another function** this will not refer to the object. so the solution of this to make this function **arrow func** 
- **arrow func** : it don't make it's this it only inherit it from their parent 
```javascript
let person = {
    name: 'hambozo',
    ...
    calcSalary: function () {
        ...
        return this.salary - calcTax(); //this is 
    }
}
```
